...
import com.mywork.user.sevice.business.OrderSevice;
...
public class UserController {
	...
	public String login(@RequestBody User user,HttpServletRequest request) {
		...
		System.err.println(redisTemplate.opsForValue().get(token));
		return token ;
	}
	...
	public String from() {
		...
		return from+user.toString()+orderSevice.hello("hello order service") ;
	}
}
